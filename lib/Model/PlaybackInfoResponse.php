...
/**
 * PlaybackInfoResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class PlaybackInfoResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PlaybackInfoResponse';
    ...
    protected static $openAPITypes = [
        ...
        'error_code' => '\OpenAPI\Client\Model\PlaybackErrorCode'
    ];
    ...
    */
     ...
     * Sets media_sources
     *
     * @param \OpenAPI\Client\Model\MediaSourceInfo[]|null $media_sources Gets or sets the media sources.
     *
     * @return self
     */
    public function setMediaSources($media_sources)
    {
        if (is_null($media_sources)) {
            throw new \InvalidArgumentException('non-nullable media_sources cannot be null');
        }
     ...
     * Gets error_code
     *
     * @return \OpenAPI\Client\Model\PlaybackErrorCode|null
     */
     ...
     * Sets error_code
     *
     * @param \OpenAPI\Client\Model\PlaybackErrorCode|null $error_code error_code
     *
     * @return self
     */
