...
/**
 * UpdateInitialConfigurationRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateInitialConfigurationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateInitialConfiguration_request';
    ...
    */
     ...
     * Sets ui_culture
     *
     * @param string|null $ui_culture Gets or sets UI language culture.
     *
     * @return self
     */
    public function setUiCulture($ui_culture)
    {
        if (is_null($ui_culture)) {
            array_push($this->openAPINullablesSetToNull, 'ui_culture');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ui_culture', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param string|null $preferred_metadata_language Gets or sets the preferred language for the metadata.
     *
     * @return self
     */
