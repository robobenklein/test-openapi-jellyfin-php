...
/**
 * AllThemeMediaResultThemeVideosResult Class Doc Comment
 *
 * @category Class
 ...
 */
class AllThemeMediaResultThemeVideosResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AllThemeMediaResult_ThemeVideosResult';
    ...
    */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\BaseItemDto[]|null $items Gets or sets the items.
     *
     * @return self
     */
     ...
     *
     * @param int|null $total_record_count Gets or sets the total number of records available.
     *
     * @return self
     */
     ...
     * Sets start_index
     *
     * @param int|null $start_index Gets or sets the index of the first record in Items.
     *
     * @return self
     */
     ...
     * Sets owner_id
     *
     * @param string|null $owner_id Gets or sets the owner id.
     *
     * @return self
     */
