...
/**
 * WakeOnLanInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class WakeOnLanInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WakeOnLanInfo';
    ...
    */
     ...
     * Sets mac_address
     *
     * @param string|null $mac_address Gets the MAC address of the device.
     *
     * @return self
     */
     ...
     * Sets port
     *
     * @param int|null $port Gets or sets the wake-on-LAN port.
     *
     * @return self
     */
